...
const CLIENTS: Client[] = [
  ...
  { name: 'EPAM', label: 'EPAM', className: 'font-display font-black tracking-tight text-[1.6em]' },
  { name: 'Neoris', label: 'neoris', className: 'font-body font-medium lowercase tracking-wide text-[1.5em]' },
