...
import { Users, Calendar, Crosshair, Compass, Ghost, Skull, PartyPopper, KeyRound, Sparkles } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="text-xs text-muted-foreground line-clamp-2 mb-3 min-h-[2.5rem]">{game.description}</p>
