...
const TopPlanesCumpleanosMurcia = () => (
  <BlogArticleLayout slug="top-5-planes-cumpleanos-murcia">
    ...
    <p>
      <strong className="text-foreground">Ideal para:</strong> <strong className="text-foreground">Ideal para:</strong> niños de 8 a 16 años. Grupos de 8 a 16 participantes. Los padres también pueden jugar.. Grupos de 8 a 16 participantes. Los padres también pueden jugar.
    </p>
    <p>
