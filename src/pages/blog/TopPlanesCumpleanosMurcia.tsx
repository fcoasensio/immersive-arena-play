  ...
  <BlogArticleLayout slug="top-5-planes-cumpleanos-murcia">
    ...
    <div className="p-6 rounded-xl border border-neon-blue/30 bg-neon-blue/5">
      ...
      <ul className="space-y-2">
        <li>🎯 <strong className="text-foreground">Laser Tag:</strong> acción y competición. 8-16 años. Desde 25€/persona.</li>🎯 <strong className="text-foreground">Laser Tag:</strong> acción y competición. 8-16 años. Desde 25€/persona.</li>. Desde 25€/persona.</li>
