  ...
  <BlogArticleLayout slug="top-5-planes-cumpleanos-murcia">
    ...
    <div className="p-6 rounded-xl border border-neon-blue/30 bg-neon-blue/5">
      ...
      <ul className="space-y-2">
        <li>🎯 <strong className="text-foreground">Laser Tag:</strong> acción y competición. 8-80 años. Desde 25€/persona.</li>
        <li>🥽 <strong className="text-foreground">Realidad Virtual:</strong> tecnología e inmersión. 12+ años.</li>
        <li>🌿 <strong className="text-foreground">Naturaleza:</strong> aire libre y aventura. Todas las edades.</li>
        <li>🎭 <strong className="text-foreground">Temáticas:</strong> magia y fantasía. 8-80 años.</li>
        <li>🎉 <strong className="text-foreground">Combinadas:</strong> lo mejor de todo.</li>
      </ul>
    </div>
  </BlogArticleLayout>
);
