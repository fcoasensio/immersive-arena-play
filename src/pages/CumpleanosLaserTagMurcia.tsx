...
import heroBg from '@/assets/recursos/cumpleanos-laser-tag.jpg';
      ...
      >
        ...
        <div className="p-6 rounded-xl border border-neon-blue/30 bg-neon-blue/5">
          ...
          <ul className="space-y-2 mt-4">
            ...
            <li className="flex items-center gap-2"><Gift className="w-4 h-4 text-neon-blue" /> <strong className="text-foreground">Incluye:</strong> video-invitación + diploma + partidas + monitor + menu completo + zona merienda</li>
          </ul>
        </div>
      </SEOLandingLayout>
    </>
