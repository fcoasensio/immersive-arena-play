...
export const vrGames: VRGame[] = [
  ...
  { slug: 'magic', name: 'Magic', provider: 'battlestart', category: 'adventure', minAge: 12, maxPlayers: 16, description: 'Aventura mágica con hechizos y criaturas fantásticas.', image: imgMagic },
  ...
  { slug: 'penguins', name: 'Penguins', provider: 'battlestart', category: 'party', minAge: 12, maxPlayers: 16, description: 'Rescata pingüinos bebés en una aventura helada cooperativa.', image: imgParty1 },
  { slug: 'dino-dance', name: 'Dino Dance', provider: 'battlestart', category: 'party', minAge: 12, maxPlayers: 16, description: 'Baila siguiendo los pasos de Dino-boy. Risas garantizadas.', image: imgParty2 },
  { slug: 'vegas', name: 'Vegas', provider: 'battlestart', category: 'party', minAge: 12, maxPlayers: 16, description: 'Party game al estilo casino de Las Vegas. ¡La banca contra ti!', image: imgVegas },
  ...
  { slug: 'vex-superhero', name: 'Superhero', provider: 'vex', category: 'shooter', minAge: 12, maxPlayers: 8, description: 'Conviértete en superhéroe con superpoderes y vuelo libre.', image: imgVexSuperhero },
  { slug: 'vex-pixel-hack', name: 'Pixel Hack', provider: 'vex', category: 'shooter', minAge: 12, maxPlayers: 8, description: 'Shooter arcade con estética pixel-art retro-futurista.', image: imgVexPixelHack },

  // Aventura
  { slug: 'vex-dragonfall', name: 'Dragonfall', provider: 'vex', category: 'adventure', minAge: 12, maxPlayers: 8, description: 'Caza dragones en un reino de fantasía épica.', image: imgVexDragonfall },
  { slug: 'vex-kraken-island', name: 'Kraken Island', provider: 'vex', category: 'adventure', minAge: 12, maxPlayers: 8, description: 'Aventura pirata: enfréntate al kraken para hacerte con el tesoro.', image: imgVexKrakenIsland },
  { slug: 'vex-temple-quest', name: 'Temple Quest', provider: 'vex', category: 'adventure', minAge: 12, maxPlayers: 8, description: 'Explora un templo ancestral lleno de trampas y reliquias.', image: imgVexTempleQuest },
  { slug: 'vex-lunar-scape', name: 'Lunar Scape', provider: 'vex', category: 'adventure', minAge: 12, maxPlayers: 8, description: 'Misión lunar con gravedad cero y paisajes alienígenas.', image: imgVexLunarScape },
  { slug: 'vex-space-academy', name: 'Space Academy', provider: 'vex', category: 'adventure', minAge: 12, maxPlayers: 8, description: 'Academia espacial: pilota naves y supera pruebas galácticas.', image: imgVexSpaceAcademy },
  { slug: 'vex-school-of-magic', name: 'School of Magic', provider: 'vex', category: 'adventure', minAge: 12, maxPlayers: 8, description: 'Aprende hechizos en una escuela de magia tipo Hogwarts.', image: imgVexSchoolOfMagic },
  { slug: 'vex-alice-in-wonderland', name: 'Alice in Wonderland', provider: 'vex', category: 'adventure', minAge: 12, maxPlayers: 8, description: 'Sumérgete en el País de las Maravillas con personajes icónicos.', image: imgVexAlice },
  ...
  // Party / Familia
  { slug: 'vex-party-playland', name: 'Party Playland', provider: 'vex', category: 'party', minAge: 12, maxPlayers: 8, description: 'Recopilación de minijuegos festivos perfectos para grupos.', image: imgVexPartyPlayland },
  { slug: 'vex-kitchen-panic', name: 'Kitchen Panic', provider: 'vex', category: 'party', minAge: 12, maxPlayers: 8, description: 'Cocina cooperativa caótica al estilo Overcooked en VR.', image: imgVexKitchenPanic },
  { slug: 'vex-bblock', name: 'B-Block', provider: 'vex', category: 'party', minAge: 12, maxPlayers: 8, description: 'Construye y compite con bloques en un party game creativo.', image: imgVexBblock },
  { slug: 'vex-greenium', name: 'Greenium', provider: 'vex', category: 'party', minAge: 12, maxPlayers: 8, description: 'Aventura ecológica con minijuegos en escenarios naturales.', image: imgVexGreenium },

  // Escape Room
  { slug: 'vex-parvus-box', name: 'Parvus Box', provider: 'vex', category: 'escape', minAge: 12, maxPlayers: 6, description: 'Escape room cooperativo con enigmas dentro de una caja misteriosa.', image: imgVexParvusBox },
];
